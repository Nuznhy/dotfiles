...
plugins=(git git-auto-fetch emoji encode64 web-search dirhistory dotenv jsontools zsh-z zsh-autosuggestions zsh-syntax-highlighting)
...
#   export EDITOR='mvim'
# fi
# fuck preffered, I wanna always use nvim
export EDITOR='nvim'
# Compilation flags
